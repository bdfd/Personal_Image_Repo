...
var header = document.querySelector(".monaka-header");
var menu = document.querySelector(".monaka-menu");
...
var configurator = new Vue({
    ...
    methods: {
        init: function() {
            ...
            this.updateMain(this.main);
            this.updateSubmenu(this.submenu);
            this.updateTransition(this.transition);
        },
        loadLocalStorage: function() {
            try {
                var raw = localStorage.getItem("monaka-menu");
                ...
                if (raw) {
                    ...
                    this.is_configuration_open = data.is_configuration_open;
                    this.primary_color = data.primary_color;

                    document.documentElement.style.setProperty("--color-primary", data.primary_color);
                }
            } catch (e) {
                console.log("loadLocalStorage:", e);
            }
        },
        updateLocalStorage: function() {
            try {
                localStorage.setItem("monaka-menu", JSON.stringify({
                    ...
                    is_configuration_open: this.is_configuration_open,
                    primary_color: this.primary_color,
                }));
            } catch (e) {
                console.log('updateLocalStorage:', e);
            }
        },
        updateContent: function(value) {
            var clone = menu_clone.cloneNode(true);

            switch (value) {
                case "default":
                    // remove icons
                    Array.prototype.slice.call(clone.querySelectorAll(".fas")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove all arrows
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-item > a > .monaka-menu-arrow")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove all dropdown
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-item > ul")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove mega-menu classes
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-item")).forEach(function(node) {
                        node.classList.remove("monaka-item-mega-menu");
                    });

                    menu.innerHTML = clone.innerHTML;
                    return this.initKnoxMenu();
                ...
                case "dropdown":
                    ...
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-item-mega-menu > a > .monaka-menu-arrow")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove mega-menu dropdown
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-item-mega-menu > ul")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });
                ...
                case "dropdown-with-icons":
                    // remove main-menu icons
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-body > li > a > .fas")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove main-menu icons for center-1
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-body > li:not(.monaka-menu-item) > ul > li > a > .fas")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });
                ...
                case "mega":
                    ...
                    // remove arrow
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-item:not(.monaka-item-mega-menu) > a > .monaka-menu-arrow")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });

                    // remove dropdown
                    Array.prototype.slice.call(clone.querySelectorAll(".monaka-menu-item:not(.monaka-item-mega-menu) > ul")).forEach(function(node) {
                        node.parentNode.removeChild(node);
                    });
                ...
                case "combination-with-icons":
                    menu.innerHTML = clone.innerHTML;
                    return this.initKnoxMenu();
            }
        },
        initKnoxMenu: function() {
            try {
                window.KnoxMenu();
            } catch (e) {}
        },
        updateTheme: function(value) {
            header.classList.remove("monaka-header-dark", "monaka-header-primary");

            switch (value) {
                case "dark":
                    return header.classList.add("monaka-header-dark");
                case "primary":
                    return header.classList.add("monaka-header-primary");
            }
        },
        updateHeader: function(value) {
            header.classList.remove("monaka-header-overlay-dark-bg", "monaka-header-overlay-light-bg", "monaka-header-transparent-light", "monaka-header-transparent-dark");

            this.updateBanner(value);

            switch (value) {
                case "overlay-light-bg":
                    return header.classList.add("monaka-header-overlay-light-bg");
                case "overlay-dark-bg":
                    return header.classList.add("monaka-header-overlay-dark-bg");
                case "transparent-light":
                    return header.classList.add("monaka-header-transparent-light");
                case "transparent-dark":
                    return header.classList.add("monaka-header-transparent-dark");
            }
        },
        updateShadow: function(value) {
            header.classList.remove("monaka-shadow-medium", "monaka-shadow-large");

            switch (value) {
                case "medium":
                    return header.classList.add("monaka-shadow-medium");
                case "large":
                    return header.classList.add("monaka-shadow-large");
            }
        },
        updateMain: function(value) {
            menu.classList.remove(
                "monaka-menu-underline",
                "monaka-menu-hover-gray",
                "monaka-menu-hover-primary",
                "monaka-menu-line-separator"
            );

            switch (value) {
                case "line-separator":
                    return menu.classList.add("monaka-menu-line-separator");
                case "hover-gray":
                    return menu.classList.add("monaka-menu-hover-gray");
                case "hover-primary":
                    return menu.classList.add("monaka-menu-hover-primary");
                case "underline":
                    return menu.classList.add("monaka-menu-underline");
            }
        },
        updateSubmenu: function(value) {
            menu.classList.remove(
                "monaka-submenu-line-separator",
                "monaka-submenu-hover-gray",
                "monaka-submenu-hover-primary"
            );

            switch (value) {
                case "line-separator":
                    return menu.classList.add("monaka-submenu-line-separator");
                case "hover-gray":
                    return menu.classList.add("monaka-submenu-hover-gray");
                case "hover-primary":
                    return menu.classList.add("monaka-submenu-hover-primary");
            }
        },
        updateTransition: function(value) {
            menu.classList.remove(
                "monaka-submenu-fade-up",
                "monaka-submenu-fade-down",
                "monaka-submenu-scale",
                "monaka-submenu-slide-up",
                "monaka-submenu-slide-down",
                "monaka-submenu-swing"
            );

            switch (value) {
                case "fade-up":
                    return menu.classList.add("monaka-submenu-fade-up");
                case "fade-down":
                    return menu.classList.add("monaka-submenu-fade-down");
                case "scale":
                    return menu.classList.add("monaka-submenu-scale");
                case "slide-up":
                    return menu.classList.add("monaka-submenu-slide-up");
                case "slide-down":
                    return menu.classList.add("monaka-submenu-slide-down");
                case "swing":
                    return menu.classList.add("monaka-submenu-swing");
            }
        },
        updateBanner: function(value) {
            banner.classList.add("banner-overlay");

            switch (value) {
                case "overlay-light-bg":
                    return banner_image.src = "images/" + "banner-overlay-light-bg" + ".jpg";
                case "overlay-dark-bg":
                    return banner_image.src = "images/" + "banner-overlay-dark-bg" + ".jpg";
                case "transparent-light":
                    return banner_image.src = "images/" + "banner-transparent-light" + ".jpg";
                case "transparent-dark":
                    banner.classList.remove("banner-overlay");
                    return banner_image.src = "images/" + "banner-transparent-dark" + ".jpg";
                default:
                    return banner_image.src = "images/" + "banner-default" + ".jpg";
            }
        ...
        onReset: function(event) {
            ...
            if (confirm("Reset to default settings?")) {
                try {
                    ...
                    alert("page local storage: " + err.message);
                }
            }
        },
        onChange: function(event) {
            ...
            if (is_IE11) return window.location.reload();

            switch (name) {
                case "content":
                    return this.updateContent(node.value);
                case "theme":
                    return this.updateTheme(node.value);
                case "header":
                    return this.updateHeader(node.value);
                case "shadow":
                    return this.updateShadow(node.value);
                case "main":
                    return this.updateMain(node.value);
                case "submenu":
                    return this.updateSubmenu(node.value);
                case "transition":
                    return this.updateTransition(node.value);
            }
        },
        onConfigOpenClose: function(event) {
            this.is_configuration_open = event.target.checked;
        ...
        onChangePrimaryColor: function(event) {
            ...
            this.primary_color = event.target.value;
        ...
        onCopyHTML: function() {
            try {
                var header = document.querySelector(".monaka-header");
                var header_spacer = header.nextElementSibling;
                copyTextToClipboard(
                    "<!-- MONAKA HEADER -->\n" +
                    header.outerHTML + "\n" +
                    header_spacer.outerHTML + "\n" +
                    "<!-- MONAKA HEADER END -->\n"
                );
                alert("Header HTML code copied to clipboard");
            } catch (err) {
                alert(err.message);
            }
        },
